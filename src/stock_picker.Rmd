...
```{r}
# Fetch historical data for the DJIA index using quantmod due to incomplete series for DJI in tidyquant. Versions used tidyquant 1.0.3, quantmod 0.4.20. These stopped working on 2024-09-15 with an HFTTP error 401.
