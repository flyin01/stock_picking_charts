...
for (i in unique(index_info$symbol)) {
  ...
  # check if the symbol data is in cache
  if (file.exists(paste0(i, ".rds"))) {
    # load the symbol data from cache
    df <- readRDS(paste0(i, ".rds"))
  } else {
    ...
    # save the symbol data to cache in folder /src/*.rds. This is not relevant for chaning stock data!
...
2022-11-05. Using broader "DOWGLOBAL" w 156 stocks. 12 stocks above dc. 5 stocks from DOW small.
2022-11-12. Same 12 stocks above dc. Increasing positive movement in some.
2022-11-17. 13 stocks above dc. GS is in.
2022-11-29. 16 stocks above dc. HON, NFLX, TRV, WMT is in. NEE is out.
2022-12-05. 19 stocks above dc. CAT, HWM, IBM are in. +3% DOW rise last month.
2022-12-11. 23 stocks above dc. AIG, GE, JPM, WFC are in.
...
2023-01-26. 21 stocks above dc. WBA in.
2023-02-03. 20 stocks above dc. AXP in. UNH, WBA out. Date was biggest stock increase YTD in OMXS. 
