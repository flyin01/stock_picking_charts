...
```{r}
today <- Sys.Date()-1 # Added -1 since sometimes the last day has two entries, this throws and error from "zoo" if dates are not unique

# Add the value to the vline on the xintercept
value <- as.Date("2026-02-28") # Date when Trump attacked Iran. Adjust accordingly
```
...
df <- tidyquant::tq_get("TSLA", # From DOWGLOBAL "ABBV" 
       get = "stock.prices",
       from = today - 4*365,
       to = today) 
...
```{r}
# Alt 2. Fetch historical data for the DJIA and VIX index using quantmod due to incomplete series for DJI in tidyquant. 
# Versions used tidyquant 1.0.3, quantmod 0.4.20. These stopped working on 2024-09-15 with an HTTP error 401.

# Create list if reference symbols for over all market behaviour
reference_symbols = list("^DJI","^VIX","^SPX")
...
# slice data frame for symbol 3 for plotting
df_slice = df %>% 
  dplyr::filter(symbol == reference_symbols[3])
...
2025-12-22. 19 stocks above dc. BA, DIS, HD out. KO, MCD in. DJI up to 48134, VIX down to 15.
2026-01-06. 19 stocks above dc. Same status. DJI up 48977, VIX at 15. Trump captured Maduro.
2026-01-13. 19 stocks above dc. No change. DJI up 49590, VIX unchanged 15.
2026-02-01. 20 stocks above dc. BA, UNH in. MSFT out. DJI down 48892, VIX up 17.
2026-02-06. 21 stocks above dc. HON in. DJI up 50116, VIX up 20.
2026-02-15. 21 stocks above dc. No change. JNJ, MCD ath. DJI down 49500, VIX same 20.
2026-02-22. 20 stocks above dc. UNH out. DJI up 49625 VIX down 19.
2026-03-14. 20 stocks above dc. AMZN, IBM out. SHW, VZ in. DJI down 46677, VIX up 27. Trump attacked Iran in March.
2026-03-25. 20 stocks above dc. AXP out. PG in. DJI down 46206, VIX down 26. Trump´s Iran war on the 3rd week.
2026-03-29. 19 stocks above dc. JPM out. DJI down to 45063, VIX down 31.
2026-04-12. 17 stocks above dc. MMM, SWH out. DJI up to 47916, VIX down 19. 
2026-04-19. 17 stocks above dc. No change. DJI is up 49447, VIX down to 17.
2026-04-26. 15 stocks above dc. BA, PG out. DJI down 49231, VIX up to 19.
2026-05-03. 15 stocks above dc. Same status. DJI is up 49499, VIX down to 17.
2026-05-14. 15 stocks above dc. MCD out. AMZN in. DJI up to 49760, VIX up 18.
2026-06-07. 17 stocks above dc. BA, UNH in. DJI up 50867, VIX up to 21. DJI all time high this week.
2026-06-26. 18 stocks above dc. JPM in. DJI up 51849, VIX down to 19. DJI ath.
2026-07-16. 19 stocks above dc. GOOGL in. DJI up 52658, VIX down to 15. 
2026-08-16. 22 stocks above dc. AXP, MMM, PG, SHW in. WMT out. DJI 53732, VIX down to 14.
2026-09-06. 20 stocks above dc. BA, HON, PG out. MSFT in. DJI down to 53414, VIX 15.
2026-09-20. 21 stocks agove dc. CRM in. DJI down 51682, VIX 14.
```{r}
...
server <- function(input, output) {
  output$plot <- renderPlot({
    ...
    date_breaks <- c(date_breaks, as.Date(max(df_comp_results$date)))
    # 
